        ...
        AutoOverCharge = Class(SDFChronotronOverChargeCannonWeapon) {
            OnWeaponFired = function(self)
                if not self.AA then
					...
					self.unit:SetWeaponEnabledByLabel('OverCharge', false)
					self.unit:GetWeaponManipulatorByLabel('OverCharge'):SetHeadingPitch(self.unit:GetWeaponManipulatorByLabel('AutoOverCharge'):GetHeadingPitch())
                    self.AA = true
                end
